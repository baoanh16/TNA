...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
	...
	<asp:Panel ID="pnlRegister" CssClass="wrap-secure wrap-register signup-page" runat="server">
		<div class="container">
			<div class="row">
				<div class="col-md-10 col-lg-8 col-xl-6" style="margin:auto">
					<div class="signup-panel flex flex-wrap">
											...
											<asp:CreateUserWizardStep ID="CreateUserWizardStep1" runat="server">
												<ContentTemplate>
													...
													<div class="form-horizontal">
														...
														<asp:Panel ID="pnlUserName" runat="server" CssClass="form-group">
															...
															<div class="settingcontrol">
																...
																<asp:RequiredFieldValidator ControlToValidate="UserName" ID="UserNameRequired" runat="server" Display="Dynamic"
																 SetFocusOnError="true" ValidationGroup="profile" SkinID="Registration"></asp:RequiredFieldValidator>
																<asp:RegularExpressionValidator ID="regexUserName" runat="server" ControlToValidate="UserName" Display="Dynamic"
																 SetFocusOnError="true" ValidationExpression="" ValidationGroup="profile" Enabled="false" SkinID="Registration"></asp:RegularExpressionValidator>
																<asp:CustomValidator ID="FailSafeUserNameValidator" runat="server" ControlToValidate="UserName" Display="Dynamic"
																 SetFocusOnError="true" ValidationGroup="profile" EnableClientScript="false" SkinID="Registration"></asp:CustomValidator>
														...
														<div class="form-group">
															...
															<div class="settingcontrol">
																...
																<asp:RequiredFieldValidator ControlToValidate="Email" ID="EmailRequired" runat="server" Display="Dynamic"
																 SetFocusOnError="true" ValidationGroup="profile" SkinID="Registration"></asp:RequiredFieldValidator>
														...
														<asp:Panel ID="divConfirmEmail" runat="server" Visible="false" CssClass="form-group">
															...
															<div class="settingcontrol">
																...
																<asp:RequiredFieldValidator ControlToValidate="ConfirmEmail" ID="ConfirmEmailRequired" runat="server"
																 Display="Dynamic" SetFocusOnError="true" ValidationGroup="profile" Enabled="false" SkinID="Registration"></asp:RequiredFieldValidator>
																<asp:CompareValidator ControlToCompare="Email" ControlToValidate="ConfirmEmail" ID="EmailCompare" runat="server"
																 Display="Dynamic" SetFocusOnError="true" ValidationGroup="profile" Enabled="false" SkinID="Registration"></asp:CompareValidator>
																<asp:Panel ID="pnlEmailConfirmHint" runat="server" CssClass="hint" Visible="false">
																	<gb:SiteLabel ID="SiteLabel8" runat="server" ConfigKey="RegisterEmailConfirmHint" UseLabelTag="false" />
																</asp:Panel>
															</div>
														</asp:Panel>
														<div class="form-group">
															...
															<span>(*)</span>
															<div class="settingcontrol">
																<telerik:RadTextBox runat="server" ID="Password" EnableViewState="false" TabIndex="10" MaxLength="20"
																 CssClass="form-control" Width="100%" TextMode="Password" EnableSingleInputRendering="false">
																...
																<asp:RequiredFieldValidator ControlToValidate="Password" ID="PasswordRequired" Display="Dynamic"
																 SetFocusOnError="true" runat="server" ValidationGroup="profile" SkinID="Registration"></asp:RequiredFieldValidator>
																<asp:CustomValidator ID="PasswordRulesValidator" runat="server" ControlToValidate="Password" Display="Dynamic"
																 SetFocusOnError="true" ValidationGroup="profile" EnableClientScript="false" SkinID="Registration"></asp:CustomValidator>
																<asp:RegularExpressionValidator ID="PasswordRegex" runat="server" ControlToValidate="Password" Display="Dynamic"
																 SetFocusOnError="true" ValidationGroup="profile" SkinID="Registration"></asp:RegularExpressionValidator>
														...
														<div class="form-group">
															<gb:SiteLabel ID="lblRegisterConfirmPassword1" runat="server" ForControl="ConfirmPassword" CssClass="settinglabel control-label"
															...
															<div class="settingcontrol">
																...
																<asp:RequiredFieldValidator ControlToValidate="ConfirmPassword" ID="ConfirmPasswordRequired" runat="server"
																 Display="Dynamic" SetFocusOnError="true" ValidationGroup="profile" SkinID="Registration"></asp:RequiredFieldValidator>
																<asp:CompareValidator ControlToCompare="Password" ControlToValidate="ConfirmPassword" ID="PasswordCompare"
																 runat="server" Display="Dynamic" SetFocusOnError="true" ValidationGroup="profile" SkinID="Registration"></asp:CompareValidator>
																<asp:Panel ID="pnlConfirmPasswordHint" runat="server" CssClass="hint" Visible="false">
																	<gb:SiteLabel ID="SiteLabel6" runat="server" ConfigKey="RegisterConfirmPasswordHint" UseLabelTag="false" />
																</asp:Panel>
															</div>
														</div>
														<div class="form-group" id="divQuestion" runat="server">
															...
															<div class="settingcontrol">
																...
																<asp:RequiredFieldValidator ControlToValidate="Question" ID="QuestionRequired" runat="server" Display="Dynamic"
																 SetFocusOnError="true" ValidationGroup="profile" SkinID="Registration"></asp:RequiredFieldValidator>
															</div>
														</div>
														<div class="form-group" id="divAnswer" runat="server">
															...
															<div class="settingcontrol">
																...
																<asp:RequiredFieldValidator ControlToValidate="Answer" ID="AnswerRequired" runat="server" Display="Dynamic"
																 SetFocusOnError="true" ValidationGroup="profile" SkinID="Registration"></asp:RequiredFieldValidator>
															</div>
														</div>
														<asp:Panel ID="pnlRequiredProfileProperties" runat="server">
														</asp:Panel>
														<asp:Panel ID="pnlSubscribe" CssClass="form-group reg-subscribe" runat="server" Visible="false">
															<div class="settingcontrol">
																<asp:CheckBox ID="chkSubscribe" runat="server" />
																<asp:Label ID="lblNewsletterListHeading" runat="server" CssClass="letterlist" />
															</div>
														</asp:Panel>
														<asp:Panel CssClass="form-group captcha reg-captcha" ID="divCaptcha" runat="server">
															...
															<div class="settingcontrol">
																<telerik:RadCaptcha ID="captcha" runat="server" ValidationGroup="profile" EnableRefreshImage="true"
																 ...
																 CaptchaTextBoxCssClass="form-control" CaptchaTextBoxTitle="<%$Resources:Resource, CaptchaInstructions %>"
											...
											<asp:CompleteWizardStep ID="CompleteWizardStep1" runat="server">
												<ContentTemplate>
													<div class="regcomplete">
														...
														<asp:Button SkinID="DefaultButton" ID="ContinueButton" runat="server" CausesValidation="False"
														 CommandName="Continue" ValidationGroup="CreateUserWizard1" />
													</div>
													<div class="clear"></div>
												</ContentTemplate>
