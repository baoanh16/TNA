...
<asp:Content ContentPlaceHolderID="mainContent" ID="MPContent" runat="server">
	<asp:Panel ID="pnlLogin" CssClass="wrap-secure wrap-login login-page" runat="server">
		<div class="container">
			<div class="row">
				<div class="col-md-10 col-lg-8 col-xl-6" style="margin:auto">
					<div class="login-panel flex flex-wrap">
						<div class="login-form">
							...
							<asp:Panel ID="pnlBottomContent" runat="server" Visible="false" CssClass="logincontent logincontentbottom"
							 EnableViewState="false">
