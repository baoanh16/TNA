		...
		<div class="container">
			<div class="row">
				<div class="col-md-10 col-lg-8 col-xl-6" style="margin:auto">
					<div class="wrap-secure wrap-recover forgot-password">
									...
									<UserNameTemplate>
										<asp:Panel ID="pnlRecover" runat="server" DefaultButton="SubmitButton">
											<div class="form-group">
												<asp:Label ID="lblEnterUserName" CssClass="settinglabel control-label" AssociatedControlID="UserName" runat="server" />
											...
											<div class="form-group">
												<asp:Button SkinID="DefaultButton" CssClass="btn btn-default btn-block" ID="SubmitButton" runat="server"
