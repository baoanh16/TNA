    ...
    <div class="table-responsive">
      <table class="table">
        <thead>
          <tr>
            <th class="text_left">
              <xsl:value-of select="/OrderList/CodeText"></xsl:value-of>
            </th>
            <th class="text_center">
              <xsl:value-of select="/OrderList/ProductText"></xsl:value-of>
            </th>
            <th class="text_center">
              <xsl:value-of select="/OrderList/DateBuyText"></xsl:value-of>
            </th>
            <th class="text_right">
              <xsl:value-of select="/OrderList/TotalText"></xsl:value-of>
            </th>
            <th class="text_center">
              <xsl:value-of select="/OrderList/OrderStatusText"></xsl:value-of>
            </th>
          </tr>
        </thead>
        <tbody>
