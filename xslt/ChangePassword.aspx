									...
									<ChangePasswordTemplate>
										<div class="account-form clearfix">
											<asp:Panel ID="divCurrentPassword" runat="server" class="form-group">
												...
												<asp:RequiredFieldValidator ControlToValidate="CurrentPassword" ID="CurrentPasswordRequired" Display="Dynamic"
											...
											<div class="form-group clearfix">
												...
												<telerik:RadTextBox runat="server" ID="NewPassword" CssClass="form-control" Width="100%"
												...
												<asp:RequiredFieldValidator ControlToValidate="NewPassword" ID="NewPasswordRequired" runat="server" Display="Dynamic"
												...
												<asp:CustomValidator ID="NewPasswordRulesValidator" runat="server" ControlToValidate="NewPassword" Display="Dynamic"
												 ValidationGroup="ChangePassword1" />
											</div>
											<div class="form-group clearfix">
												...
												<asp:RequiredFieldValidator ControlToValidate="ConfirmNewPassword" ID="ConfirmNewPasswordRequired" runat="server"
												 Display="Dynamic" ValidationGroup="ChangePassword1" />
												<asp:CompareValidator ControlToCompare="NewPassword" ControlToValidate="ConfirmNewPassword" ID="NewPasswordCompare"
											...
											<asp:Button SkinID="DefaultButton" ID="ChangePasswordPushButton" CommandName="ChangePassword" Text="Change Password"
											 runat="server" ValidationGroup="ChangePassword1" />
